...
For our project, we would like to recreate a still scene from the k-drama Lovely Runner with cats instead of humans. In the scene, one cat holds a yellow umbrella over another cat in the snow. We want to have the cats be static, while the environment will be dynamic (the snow will be falling around them).
